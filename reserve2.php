...
<!-- =============== START OF MAIN CONTENT ================= -->
			<div class="item">
				...
				<!-- ===== FORM ==== -->	
				<div class="maincol_5">
					<form method=post action="http://www.deksilp.com/stulist/mail2.php">
						<table cellpadding=5>
							<tr>
							...
							<tr>
								<td><span class="strong">อีเมล์</span><br />(หากสมัครหลายคน จะระบุุอีเมล์คนเดียวก็ได้ หรือระบุหลายอีเมล์ก็ได้ คั่นด้วย ,)</td>
							...
							<tr>
								<td class="strong">ในการจองคอร์สเรียน ให้ระบุ 
									<br /><span class="blue">"ชื่อคอร์ส และสาขา(ถ้าเป็นคอร์สสดระบุวันเวลาด้วย)"</span> เช่น 
									<br /><span class="orange">AD1 สอนสด+Sensation ราชเทวี กรกฎา เสาร์เช้า 
									<br /><br />หรือ DREAM1 สอนสด+Sensation สยามสแควร์ มิถุนา เสาร์เช้า
                                    <br /><br /><br />หรือ DREAM1 Sensation @Home
									<br /><br />หรือ AD1 Sensation@AC'CESS ชลบุรี
                                    </span>
                                    ...
                                    เช่น กรณีเรียนที่ ZA-SHI หรือเรียน @Home ที่บ้านจะต้องโอนเข้าบัญชีครูพรหมเทพ เท่านั้น<br />
                                    หากเรียนที่สาขาของ AC'CESS ให้โอนเข้าบัญชี อ.ชัชชัย ค่ะ
								</td>
