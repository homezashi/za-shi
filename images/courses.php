...
<!-- =============== START OF MAIN CONTENT ================= -->
			...
			<div class="item course <?php echo $cor[1]; ?>" id="course1">
				...
				<div class="maincol_3"> <!-- schedule --> 
                    ...
                    <a href="images/course/Banner-AD1-AD2-Sum57.gif" target="blank"><img src="images/button_schedule_summer.png" /></a>
                    <!-- PRINT --><a href="images/course/Banner-AD1-AD2-Sum57.gif" target="blank"><img src="images/button_print.png" /></a>
                    ...
                    <!-- PRINT --><a href="images/course/Banner-AD1-AD2-Sem1-56.gif" target="blank"><img src="images/button_print.png" /></a>
                    <a href="images/course/Banner-AD1-AD2-Sum57.gif" target="blank"><img src="images/button_schedule_opensem2.png" /></a>
                    <!-- PRINT --><a href="images/course/Banner-AD1-AD2-Sum57.gif" target="blank"><img src="images/button_print.png" /></a>
            ...
            <div class="clear"></div>	
				...
				<div class="maincol_3"> <!-- schedule --> 
                    ...
                    <a href="images/course/Banner-N2N3kakushin.gif" target="blank"><img src="images/button_sensation_ad3.png" /></a>
					<!--PRINT --><a href="images/course/Banner-N2N3kakushin.gif" target="blank"><img src="images/button_print.png" /></a>
			...
			<!-- =========== THEP ============ -->
				...
				<div class="maincol_3"> <!-- schedule --> 
					...
					<a href="images/course/Banner-N2N3kakushin.gif" target="blank"><img src="images/button_sensation_ninja.png" /></a>
					<!--PRINT --><a href="images/course/Banner-N2N3kakushin.gif" target="blank"><img src="images/button_print.png" /></a>
			...
			<div class="item course <?php echo $cor[4]; ?>" id="course4">
				...
				<div class="maincol_3"> <!-- schedule -->
					...
					<!--PRINT --><a href="images/course/siam_course_sem2.jpg" target="blank"><img src="images/button_print.png" /></a>
					<a href="images/course/zelf_table.jpg" target="blank"><img src="images/button_sensation_akiko.png" /></a>
					<!--PRINT --><a href="images/course/zelf_table.jpg" target="blank"><img src="images/button_print.png" /></a>
				...
				<div class="maincol_5"> <!-- details --> 
					<img  class="imgshadow" src="images/akiko_new.gif" alt="" width=600 />
                    <img  class="imgshadow" src="images/tonkeng.jpg" alt="" width=600 />
