...
<!-- =============== START OF MAIN CONTENT ================= -->
 			...
 			<div class="item" >	                               
                ...
                <br/>
					<ul>
						...
						<li>AD2 ติวสอบ PAT ญี่ปุ่น - ZELF@AC'CESS </br>(อยู่ระหว่างการตัดต่อ)</li>
			...
			<div class="item course <?php echo $cor[1]; ?>" id="course1">
				<!-- =========== topic ============ --> <img class="course_topic" src="images/course-topic_zelfad1.png" />
				<div class="maincol_2">
			...
			<div class="item course <?php echo $cor[1]; ?>" id="course3">
				...
				<div class="maincol_3"> <!-- schedule -->
					 ...
					 Example:  <a class="popupimage" href="images/course/Banner-AD1-Sem2-54.gif"> images or text </a>
					 -->
                     <a class="popupimage" href="images/siam_course.jpg"><img src="images/button_sensation_akiko.png" /></a>
					<!--PRINT --><a href="images/siam_course.jpg" target="blank"><img src="images/button_print.png" /></a>
					<a class="popupimage" href="images/akiko.gif"><img src="images/button_dream.png" /></a>
